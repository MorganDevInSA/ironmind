...
| **[STYLE-GUIDE.md](./STYLE-GUIDE.md)**                                           | Current visual implementation guide (tokens, selected-state system, onboarding theme behavior); still defer to code tokens when conflicts appear.                                       |
