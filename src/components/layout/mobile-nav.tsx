            ...
            <div className="glass-panel-strong p-2 mx-auto max-w-sm">
              <div className="flex items-center justify-between px-3 py-2 mb-1">
                ...
                <button
                  ...
                  className="p-1 text-[color:var(--text-2)] hover:text-[color:var(--text-0)] transition-colors"
                >
      ...
      <nav className={cn(
        ...
        {primaryItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <span className="absolute bottom-0 w-6 h-0.5 rounded-t-full bg-[color:var(--accent)] [filter:drop-shadow(0_0_4px_color-mix(in_srgb,var(--accent)_60%,transparent))]" aria-hidden="true" />
              )}
            </Link>
          );
        })}
        ...
        >
          <MoreHorizontal
            ...
            aria-hidden="true"
            className={cn(
              (isMoreActive || moreOpen) && 'drop-shadow-[0_0_6px_color-mix(in_srgb,var(--accent)_55%,transparent)]'
            )}
          />
          <span className={cn(
            'text-[10px] font-semibold uppercase tracking-wide',
            isMoreActive || moreOpen ? 'text-[color:var(--accent-light)]' : 'text-[color:var(--text-detail)] opacity-95'
          )}>
            More
          </span>
          {(isMoreActive && !moreOpen) && (
