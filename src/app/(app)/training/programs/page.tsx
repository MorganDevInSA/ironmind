    ...
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          <div className="glass-panel p-5">
            <div className="flex items-start justify-between mb-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[color:var(--text-2)] mb-1">Active Program</p>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-[rgba(18,14,14,0.6)] rounded-lg p-3">
                ...
                <p className="font-mono tabular-nums text-[color:var(--text-0)] font-semibold">{program.cycleLengthDays} days</p>
              </div>
              <div className="bg-[rgba(18,14,14,0.6)] rounded-lg p-3">
          ...
          <div className="glass-panel p-5 space-y-3">
            ...
            <div className="space-y-2">
              {program.sessions.map(s => (
                <div key={s.dayNumber} className="flex items-center gap-3 py-2 border-b border-[rgba(65,50,50,0.15)] last:border-0">
                  ...
                  <span className={`text-xs font-semibold uppercase tracking-wide ${
                    s.type === 'lift' ? 'text-[color:var(--accent)]' : s.type === 'recovery' ? 'text-[#10B981]' : 'text-[color:var(--text-2)]'
                  }`}>{s.type}</span>
                </div>
              ))}
            </div>
          ...
          {program.kpis && program.kpis.length > 0 && (
            <div className="glass-panel p-5 space-y-3">
              <h3 className="font-semibold text-[color:var(--text-0)] flex items-center gap-2"><TrendingUp size={18} className="text-[color:var(--accent)]" /> KPI Lifts</h3>
      ...
      {!isLoading && !program && (
        <div className="glass-panel p-8 text-center space-y-4">
          ...
          <p className="text-[color:var(--text-2)]">No program loaded. Import your coach files to get started.</p>
