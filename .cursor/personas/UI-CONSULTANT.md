...
- **Chrome brand mark (sidebar + top bar):** **`IronmindLogo`** must use the **combined** lockup (**`logoCombined`**, same as login) — not the theme shield assets; keep the rail and mobile header uncluttered — sizing is owned by **`ironmind-logo.tsx`** (see **LOGO-BRIEF**)
